...
**What do you do?`,
    choices: [
      { id: 'stay_cabin', text: '🛏️ Stay in your cabin and wait for official instructions', impact: -0.18, outcome: `You wait. The list to port grows steeper. By the time you venture out, the corridors are flooding and the stairwells are jammed with panicked steerage passengers. Many who stayed in their cabins — like 1st Class passenger Washington Roebling — never made it to the boat deck.` },
      { id: 'go_deck', text: '🚶 Go immediately to the boat deck with your lifebelt', impact: +0.22, outcome: `You arrive early. The boat deck is calm. Officers are methodically uncovering lifeboats. You watch as Rocket signals burst overhead — the first distress call. Your early positioning gives you time to assess the situation and secure a place near Lifeboat 7.` },
      { id: 'investigate', text: '🔍 Try to learn more from crew or other passengers', impact: +0.05, outcome: `You learn from a stoker that water is flooding Boiler Room 6. The news spreads in hushed whispers through the smoking room. You gain valuable information, but the delay costs you your preferred position at the boats.` }
    ]
  },
  {
    id: 'evacuation',
...
**What do you do?`,
    choices: [
      { id: 'queue', text: '🛟 Queue calmly at the nearest lifeboat station', impact: +0.16, outcome: `Your patience pays off. Officer Lightoller (port side) or Murdoch (starboard) directs you efficiently. You maintain dignity under pressure — a trait noted by survivors. The boat lowers smoothly into the freezing black water.` },
      { id: 'find_family', text: '👨‍👩‍👧 Search for family members before approaching boats', impact: -0.14, outcome: `The search takes precious minutes. The Straus couple refused to separate. The Allison family searched for their toddler until it was too late — all three perished. By the time you return, the boats are gone or half-filled and already swinging out.` },
      { id: 'return', text: '💼 Go back inside to fetch valuables or warmer clothes', impact: -0.22, outcome: `A fatal delay. Benjamin Guggenheim returned to change into his finest evening wear. He was last seen sitting in the Grand Staircase with a brandy. The corridors are now tilting at 10 degrees. The way back up is blocked by rising water.` }
    ]
  },
  {
    id: 'crisis',
...
**What do you do?`,
    choices: [
      { id: 'accept_seat', text: '🛟 Accept a lifeboat seat if offered', impact: +0.28, outcome: `You are pulled into a boat — perhaps Lifeboat 13 or 15. The drop to the water is 60 feet. The sea is a black, calm mirror reflecting the ship's blazing lights. You hear the band playing "Nearer, My God, to Thee" as you pull away.` },
      { id: 'sacrifice', text: '⚓ Give your seat to a woman or child', impact: +0.08, outcome: `A heroic act. Isidor Straus refused a seat while women remained. His wife Ida refused to leave him. They were last seen arm-in-arm on deck. You have chosen dignity, but your survival odds now depend entirely on finding another way off.` },
      { id: 'sneak', text: '🧥 Hide under a tarp or disguise yourself', impact: +0.06, outcome: `Daniel Buckley, a 21-year-old Irishman, hid under a blanket in a lifeboat and survived. Your deception works — the boat is lowered. But you carry the weight of knowing someone else might have taken that seat.` },
      { id: 'argue', text: '💢 Argue or try to force your way onto a boat', impact: -0.28, outcome: `Officer Lightoller fires his pistol into the air. You are pushed back. The crew is now using oars to keep desperate swimmers from swamping the boats. You have burned your bridge with the officers who control the remaining launches.` }
    ]
  },
  {
    id: 'plunge',
...
**What do you do?`,
    choices: [
      { id: 'jump_swim', text: '🌊 Jump into the water and swim away from the suction', impact: +0.10, outcome: `The water is -2°C — below the freezing point due to salt. The shock takes your breath away. You swim hard away from the vortex. Charles Joughin, the baker, treaded water for 2 hours after drinking heavily. You have minutes before hypothermia sets in.` },
      { id: 'debris', text: '🪵 Leap onto a floating collapsible or wooden panel', impact: +0.26, outcome: `You find Collapsible A or B — both floated off the deck as the ship sank. It is swamped and unstable, but it keeps you out of the water. You huddle with 30 others, feet frozen in the icy sloshing, waiting for dawn.` },
      { id: 'hold_rail', text: '⚓ Hold onto the railing as the ship goes under', impact: -0.24, outcome: `The suction is immense. You are pulled down with the ship, then released 60 feet below the surface. You fight for the surface, but your lungs are burning. Most who went down with the ship never resurfaced.` },
      { id: 'stay', text: '🕯️ Stay on the stern hoping for rescue', impact: -0.32, outcome: `The stern settles back almost level for a moment, then sinks rapidly. You are trapped inside as the ship becomes your coffin. The last signal from the Titanic's wireless went out at 2:17 AM. There is no one coming to this part of the ship.` }
    ]
  }
];
...
// ── FIX: Defensive message builder — never prints "undefined" ──
function buildResponse(state, choice, scenario) {
  ...
  // ── FIX: Safe fallback so missing outcome never leaks "undefined" ──
  const choiceText = choice?.text || 'You made a choice';
  const outcomeText = choice?.outcome || '';
  const probText = `**Survival Probability: ${(state.currentProbability * 100).toFixed(0)}%**`;
  ...
  if (choice && outcomeText) {
    ...
    message = nextScenario.narrative;
  }
...
export async function POST(request) {
  try {
    ...
    const { action, session_id, passenger_data, decision_id, state: clientState, start, initial_probability, current_probability } = body;
